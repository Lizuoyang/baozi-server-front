    ...
    <el-container>
      <el-header class="dashboard-head">
        <el-form :inline="true" :model="queryForm" class="demo-form-inline">
          <el-form-item label="文件名称">
            <el-input v-model="queryForm.title" placeholder="请输入文件名称" clearable @clear="initData()"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main>
        <el-table
          ...
          <el-table-column align="center" label="文件" show-overflow-tooltip>
            <template slot-scope="scope">
              <a class="link" @click="handleDownloads(scope.row.linkUrl)">{{scope.row.linkUrl}}</a>
            </template>
          </el-table-column>
          <el-table-column
            prop="createdBy"
  ...
  export default {
    ...
    methods: {
      ...
      async handleMaterialEditBtnClick(data) {
        ...
        if (_.isEmpty(data)) {
          this.updDialog.title = '新增文件素材'
          this.updDialog.material = {}
        } else {
          this.updDialog.title = '编辑文件素材'

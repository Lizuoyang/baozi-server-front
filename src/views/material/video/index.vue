<template>
  <el-card class="box-card">
    <el-container>
      ...
      <el-main>
        <el-table
          ...
          <el-table-column align="center" prop="linkUrl" label="视频">
            <template slot-scope="props">
              <video :src="props.row.linkUrl" id="videoPlay" controls width="100%" height="100%">您的浏览器不支持 video 视屏播放。
              </video>
            </template>
          </el-table-column>
          <el-table-column
    ...
    <update-dialog style="width: 100%" :dialog="this.updDialog" ref="updateDialog"></update-dialog>
  </el-card>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleMaterialEditBtnClick(data) {
        ...
        if (_.isEmpty(data)) {
          this.updDialog.title = '新增视频素材'
          this.updDialog.material = {}
        } else {
          this.updDialog.title = '编辑视频素材'

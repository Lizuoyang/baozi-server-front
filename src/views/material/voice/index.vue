    ...
    <el-container>
      <el-header class="dashboard-head">
        <el-form :inline="true" :model="queryForm" class="demo-form-inline">
          <el-form-item label="音频名称">
            <el-input v-model="queryForm.title" placeholder="请输入音频名称" clearable @clear="initData()"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main>
        <el-table
          ...
          <el-table-column align="center" label="音频" width="360">
            <template slot-scope="scope">
              <audio :src="scope.row.linkUrl"  type=audio  controls class="yinyue"></audio>
            </template>
          </el-table-column>
          <el-table-column
            prop="createdBy"
  ...
  export default {
    ...
    methods: {
      ...
      async handleMaterialEditBtnClick(data) {
        ...
        if (_.isEmpty(data)) {
          this.updDialog.title = '新增音频素材'
          this.updDialog.material = {}
        } else {
          this.updDialog.title = '编辑音频素材'

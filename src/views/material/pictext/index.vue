    ...
    <el-container>
      <el-header class="dashboard-head">
        <el-form :inline="true" :model="queryForm" class="demo-form-inline">
          <el-form-item label="图文名称">
            <el-input v-model="queryForm.title" placeholder="请输入图文名称" clearable @clear="initData()"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main>
        <el-table
          ...
          <el-table-column align="center" prop="linkUrl" label="封面图">
            <template slot-scope="scope">
              <el-popover placement="left" title="" trigger="hover">
                <img :src="scope.row.articles[0].picUrl" alt="" style="width: 150px;height: 150px">
                <img slot="reference" :src="scope.row.articles[0].picUrl" :alt="scope.row.name"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //新增
       handleMaterialEditBtnClick(data) {
        this.$router.push({path:'/material/new_pictext',query:{picText:data}})
      },
      //初始数据
      initData() {
